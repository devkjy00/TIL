...
# 1주차
>HCI		
- [인간과 컴퓨터 간의 상호작용을 다루는 것, HCI1.0, HCI2.0]
>UX		
- [HCI의 목표, 인터페이스의 구체적인 수단]

# 2주차 
>상호작용의 절차		
- [표명:구체적정보표현(검색)-변환:받은정보를 처리장치로 변환-표현:출력도구로 전환-평가:인터페이스에 나타난 정보와목표비교]
>상호작용의 종류 	
1. 전송형 : 사업자가 만들고 전달(온라인 강의 등) ]
2. 등록형 : 사용자가 만들고 사업자가 전달(인터넷 경매 등)]
3. 문의형 : 사업자가 만들고 사용자가 요청(전자상거래 등)]
4. 대화형 : 사용자가 만들고 전달(sns)]
>컴퓨팅적 사고		
- [분해 - 패턴인식 - 추상화 - 알고리즘]
...
- [경험,숙련도,개인특성/페르소나모형]
>주,부 사용자		
- [타겟 고객층, 실제 시스템사용은 않지만 시스템에 영향을주는 사람]
>사용자 모형		
- [인지모형 : 최초모형, 사용성에 치우치고 ‘유용성’은 고려하지 못함
- 역할모형 : 인지모형을 보완, 사용자와시스템관계에 초점 ‘감성’을고려못함
- 페르소나모형 : 사용자유형을 대표하는 가상인물, 사고방식과 행동양식알아냄
- 사회기술모형 : 조직의 특성에 초점이 맞춘 모형]

# 4주차
>과업분석			
- [사용자가 디지털 제품이나 서비스를 이용해 어떤일을 수행하는지 분석하는 과정 1H5W 육하원칙]
>과업분석중요성		
- [1. 사용자목적에 부합하는 서비스
				2. 사용자가 실제 어떤 방식으로 시스템을 사용하는 지 초점(명시적(사용메뉴얼),묵시적(실사용) 지식)]
>과업분석법종류		
- [구체적분석:계층적과업,지식기반 /한단계높은수준: 시나리오, 시퀀스 모형 /가장높은수준:직업,작업흐름]
>계층적 과업 분석법	
- [각 과업을 세부과업으로 나눠서 계층적 구조를 파악/자세하다/행동분석에 부적합]
>지식 기반 분석법 	
- [전문가시스템과 같이 많은 지식을 필요로하는 시스템개발과정의 방법/체계적/나무만분석]
>시나리오 분석법		
- [사용자의 구체적경험을 순차적으로 기술/개발전체에윤곽생성,다양한문제점,현실반영/보편적이지않을수있음]
>시퀀스모형 분석법	
- [사용자에게 필요한 세부과업을 실행해 나가는 과정을기술(과정,촉발원인,사용의도,고장)]
>직업 분석법		
- [사용자가특정과업을 진행하는 과정에만 초점을 맞춰하루종일분석/아이디어제공/주관적인 분석]
>작업흐름 분석법		
- [대규모조직에서 업무흐름을 통제,증대하기위해 사용]
***제이콥 닐슨 ‘사용자가 자신의 행동을 설명하는 것과 실제로 행동하는 것은 다르다 사용자의 말이 아니라 행동하는 것을 주의하라’***
