...
<h3> 1 주차 </h3>
  <ul type="squre"> </ul>
    <li><a href="https://github.com/southoftheriver/TIL/blob/master/잡다한T끌/docs/항해/day_6.md"> 6일차(연결리스트), 러너, 투포인터 </a></li>
    <li><a href="https://github.com/southoftheriver/til/blob/master/잡다한t끌/docs/항해/day_7.md"> 7일차(스택) </a></li>
 </ul>
